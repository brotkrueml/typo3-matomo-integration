...
final class ScriptTagBuilderWithCspTest extends FunctionalTestCase
{
    /**
     * @var list<string>
     */
    ...
    protected array $pathsToProvideInTestInstance = [
        'typo3conf/ext/matomo_integration/Tests/Functional/Fixtures/SitesWithCsp/' => 'typo3conf/sites',
    ];
    ...
    protected function setUp(): void
    {
        if ((new Typo3Version())->getMajorVersion() < 12) {
            self::markTestSkipped('CSP not available');
        }
    ...
    #[Test]
    public function nonceAttributeIsAddedToScriptTagCorrectlyWithActivatedCsp(): void
    {
        ...
        self::assertMatchesRegularExpression('/' . $expectedQuoted . '/m', $body);
    }
}
