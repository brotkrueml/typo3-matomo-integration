...
namespace Brotkrueml\MatomoIntegration\Tests\Functional\Hooks\PageRenderer;
...
final class TrackingCodeInjectorTest extends FunctionalTestCase
{
    /**
     * @var list<string>
     */
    ...
    #[Test]
    public function matomoTagIsCorrectlyRendered(): void
    {
